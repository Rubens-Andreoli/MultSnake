...
public class Volume extends javax.swing.JFrame{
	...
	if(vol >= 75)
	    lbl_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/audio_h.png")));
	else if(vol >= 50)
	    lbl_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/audio_m.png")));
	else if (vol > 0)
	    lbl_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/audio_l.png")));
	else
	    lbl_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/audio_n.png")));
    }
    ...
    private void initComponents() {
        ...
        lbl_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/audio_l.png"))); // NOI18N
